...
issues (marked as confidential) or by contacting the project team directly.
...
- **Be specific**: Provide clear examples and reasoning
- **Be open-minded**: Consider different perspectives and approaches
- **Be respectful**: Disagreement is fine; disrespect is not

### Code Reviews

- **Focus on the code**: Review the code, not the person
- **Be helpful**: Suggest improvements, explain reasoning
- **Be thorough**: Take time to understand the context
- **Be appreciative**: Acknowledge good work and effort

### Issue Reporting

- **Be clear**: Provide detailed, actionable information
- **Be patient**: Maintainers are often volunteers
- **Be collaborative**: Work together toward solutions
- **Be understanding**: Not all features can be implemented

### Community Interaction

- **Welcome newcomers**: Help people get started
- **Share knowledge**: Explain concepts and approaches
